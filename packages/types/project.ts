...
export const ZProject = z.object({
  ...
  defaultRedirectOnCompleteUrl: z.string().url(),
  defaultRedirectOnFailUrl: z.string().url(),
...
export const ZProjectUpdateInput = z.object({
  ...
  defaultRedirectOnCompleteUrl: z.string().optional(),
  defaultRedirectOnFailUrl: z.string().optional(),
