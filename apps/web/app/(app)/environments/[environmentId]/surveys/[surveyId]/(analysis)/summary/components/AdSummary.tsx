...
import { TSurveyQuestionSummaryAd } from "@formbricks/types/surveys";
...
interface AdSummaryProps {
  questionSummary: TSurveyQuestionSummaryAd;
}

export const AdSummary = ({ questionSummary }: AdSummaryProps) => {
  return (
